 ...
 * @since 0.1.0
 */
final readonly class CancelDonationHandler extends AbstractDonationMutationHandler implements CancelDonationUseCase {
	...
	public function handle( EntityId $donation_id, ?UtcDateTime $at = null ): Donation {
		...
		try {
			$canceled_donation = $donation->cancel( $at );
